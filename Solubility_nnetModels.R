...
saveRDS(enetModel, 'enet_solubility_bs.rds')
...
saveRDS(knnModel, 'KNN_solubility_bs.rds')
...
saveRDS(marsModel, 'mars_solubility_bs.rds')
...
saveRDS(svmRModel, 'svm_solubility_bs.rds')
...
saveRDS(nnetModel, 'nnet_solubility_bs.rds')
...
saveRDS(rpartModel, 'rpart_solubility_bs.rds')
...
saveRDS(ctreeModel, 'ctree_solubility_bs.rds')
...
saveRDS(treebagModel, 'treebag_solubility_bs.rds')
...
saveRDS(rfModel, 'rf_solubility_bs.rds')
...
saveRDS(gbmModel, 'gbm_solubility_bs.rds')
...
saveRDS(cbModel, 'cubist_solubility_bs.rds')
...
saveRDS(mtModel, 'M5_solubility_bs.rds')
